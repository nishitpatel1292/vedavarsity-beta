      ...
      <div className="m-auto max-w-7xl space-y-[120px] px-4 py-16">
        <div className="m-auto max-w-[800px] space-y-6	 text-lg font-normal text-navy ">
          ...
          <p>
            ...
            at the browsers&lsquo; respective websites.
          </p>
          ...
          <p>
            Request that a business that collects a consumer&lsquo;s personal data disclose the
          ...
          <p>
            Request that a business that sells a consumer&lsquo;s personal data, not sell the
            consumer&lsquo;s personal data.
          </p>
          <p>
            If you make a request, we have one month to respond to you. If you would like to
            exercise any of these rights, please contact us.
          </p>
          <h2 className="text-xl font-bold text-navy">GDPR Data Protection Rights</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-navy">Children&lsquo;s Information</h2>
          <p>
